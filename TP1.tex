...
\chapter*{Travaux Pratiques thème 1 : boucles/structures de contôle}
...
\exercice{Retour des fractions egyptiennes}
Codez en C la résolution de l'exercice sur les fractions égyptiennes.
Dans le cas où votre programme fait des calculs avec des \texttt{float}, qu'observez-vous ? Pourquoi ?
